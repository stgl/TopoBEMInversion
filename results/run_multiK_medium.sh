{ matlab -nodesktop multiK_medium_enforcement_n0_667.m > multiK_medium_enforcement_n0_667.out; \
...
{ matlab -nodesktop multiK_medium_enforcement_n1_0.m > multiK_medium_enforcement_n1_0.out; \
...
{ matlab -nodesktop multiK_medium_enforcement_n2_5.m > multiK_medium_enforcement_n2_5.out; \

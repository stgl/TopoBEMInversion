...
load WeightingResults1.mat

sig_bay_weights=[-6.3 -6.4 -6.5];
sig_loma_weights=[-6.1 -6.4 -6.8];

bay_resid_weights=interp2(log_w_bay,log_w_lp,bay_resid,sig_bay_weights,sig_loma_weights);
lp_resid_weights=interp2(log_w_bay,log_w_lp,lp_resid,sig_bay_weights,sig_loma_weights);
chi_sq_outletsfree_weights=interp2(log_w_bay,log_w_lp,chi_sq_outletsfree,sig_bay_weights,sig_loma_weights);
v_s_weights=interp2(log_w_bay,log_w_lp,v_s,sig_bay_weights,sig_loma_weights);
v_n_weights=interp2(log_w_bay,log_w_lp,v_n,sig_bay_weights,sig_loma_weights);

...
nohup bash -c "matlab -nodesktop < models/singleK_strong_enforcement_n1_0.m > results/singleK_strong_enforcement_n1_0.out; \
matlab -nodesktop < models/singleK_strong_enforcement_linearized_cov_n1_0.m > results/singleK_strong_enforcement_linearized_cov_n1_0.out; \
matlab -nodesktop < models/singleK_strong_enforcement_linearized_output_n1_0.m > results/singleK_strong_enforcement_linearized_output_n1_0.out;" > singleK_strong_n1.out &

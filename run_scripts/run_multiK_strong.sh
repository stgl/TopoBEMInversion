...
nohup bash -c "matlab -nodesktop < models/multiK_strong_enforcement_n0_667.m > results/multiK_strong_enforcement_n0_667.out;" > multiK_strong_n0_667.out &

nohup bash -c "matlab -nodesktop < models/multiK_strong_enforcement_n2_5.m > results/multiK_strong_enforcement_n2_5.out;" > multiK_strong_n2_5.out &

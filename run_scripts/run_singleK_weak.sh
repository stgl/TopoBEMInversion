...
nohup bash -c "matlab -nodesktop < models/singleK_weak_enforcement_n0_667.m > results/singleK_weak_enforcement_n0_667.out;" > singleK_weak_n0_667.out &

nohup bash -c "matlab -nodesktop < models/singleK_weak_enforcement_n2_5.m > results/singleK_weak_enforcement_n2_5.out;" > singleK_weak_n2_5.out &

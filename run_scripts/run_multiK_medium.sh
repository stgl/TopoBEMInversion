...
matlab -nodesktop < models/multiK_medium_enforcement_linearized_output_n0_667.m > results/multiK_medium_enforcement_linearized_output_n0_667.out;" &
...
matlab -nodesktop < models/multiK_medium_enforcement_linearized_output_n1_0.m > results/multiK_medium_enforcement_linearized_output_n1_0.out;" &
...
matlab -nodesktop < models/multiK_medium_enforcement_linearized_output_n2_5.m > results/multiK_medium_enforcement_linearized_output_n2_5.out; " &
